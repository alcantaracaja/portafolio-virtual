    ...
    <div class="week-card">
        ...
        <p>Introducción a las Pruebas de Software</p>
                ...
                <div class="week-card">
                    <span>SEMANA</span>
                    <h3>02</h3>
                    <p>Tipos de Pruebas de Software</p>
                </div>
                ...
                <div class="week-card">
                    <span>SEMANA</span>
                    <h3>04</h3>
                    <p>Técnicas de Diseño de Casos</p>
                </div>

                <div class="week-card">
                    <span>SEMANA</span>
                    <h3>05</h3>
                    <p>Ejecución de Casos de Prueba</p>
                </div>
                ...
                <div class="week-card">
                    <span>SEMANA</span>
                    <h3>10</h3>
                    <p>Pruebas de Usabilidad</p>
                </div>

                <div class="week-card">
                    <span>SEMANA</span>
                    <h3>11</h3>
                    <p>Pruebas de Carga y Rendimiento</p>
                </div>
